    ...
    return (
        <Loading>
            <Error>
                ...
                {/* -------------------------- */}
                <section>
      <div className="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-14 bg-[#FCFCFC]">
        <div className="xl:mx-auto xl:w-full xl:max-w-md 2xl:max-w-lg shadow-xl rounded-xl px-6 py-8 bg-white">
            ...
            <div className="space-y-5">
              <div>
                ...
                <div
                  ...
                  {formErrors.email && <p className="text-red-400 mt-1 duration-500">{formErrors.email}</p>}
                   </div>
              </div>
              ...
              <div>
                ...
                <div
                  ...
                  {formErrors.password && <p className="text-red-400 mt-1 duration-500">{formErrors.password}</p>}
                </div>
              </div>

              <div className="flex justify-end">
                <a href="#" title="" className="text-sm font-semibold text-black hover:underline hover:scale-105">
                      {' '}
                      Forgot password?{' '}
                </a>
              </div>
              <div>
                <button
                  ...
                  type="button"
                  className="group inline-flex w-full items-center justify-center rounded-md bg-[#1B1B1C] px-3.5 py-2.5 font-semibold leading-7 text-white  duration-300 hover:scale-105"
                >
                  Sign in</button>
              </div>
            </div>
