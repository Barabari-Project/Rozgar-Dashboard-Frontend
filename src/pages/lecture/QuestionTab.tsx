...
const QuestionTab: React.FC<QuestionTabProps> = ({ topic }) => {
  ...
  const getUserSubmission = (question: IQuestion): UserSubmission | undefined => {
      ...
      <div className="bg-[#E6EBF0] p-1 md:p-5 m-1 md:m-3 rounded-xl">
        ...
        <div className="w-full flex flex-col gap-4">
          {topic?.questions?.map((question) => {
            const userSubmission: UserSubmission | undefined = getUserSubmission(question);
            return (
                ...
                >
                  ...
                  <div className="flex h-full items-center max-w-full w-full md:max-w-3/4 md:w-3/4 overflow-hidden gap-3 pl-2">
                    ...
                    <label className="text-white">
                      <input
                        className="dark:border-white-400/20 dark:scale-100 transition-all duration-500 ease-in-out dark:hover:scale-110 dark:checked:scale-100 w-5 h-5 mt-1 marked:bg-[#FFCB33] dark:checked:bg-[#FFCB33]"
                        type="checkbox"
                        checked={!!userSubmission}
                        readOnly
                      />
                    </label>
                  ...
                  <div className="flex h-full pl-3 md:pl-0 items-center gap-3">
                    ...
                    <button
                      onClick={() => {
                        ...
                        userSubmission && setLink(userSubmission.link);
                      }}
