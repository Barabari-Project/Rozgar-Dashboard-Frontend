  ...
  return (
    <div className="relative">
      ...
      <div className="flex relative lg:flex-row flex-col gap-5 p-2 md:py-6 md:px-6 bg-[#eceeef] w-full">
        ...
        <div
          id="left"
          className="lg:max-h-[108vh] pt-7 pb-4 px-1 sm:px-2 md:px-4 lg:px-5 w-full lg:w-3/4 bg-white rounded-xl shadow-lg"
        >
          ...
          <div className="max-h-[90%] overflow-scroll overflow-y-auto">
        ...
        <div
          id="Right"
          className="w-full max-h-[108vh] overflow-hidden lg:w-1/4 bg-white rounded-xl shadow-lg"
        >
          {/* Module Heading */}
